...
from omni.isaac.orbit.sim.spawners.spawner_cfg import (
    ClothObjectSpawnerCfg,
...
@configclass
class ClothUsdFileCfg(ClothObjectSpawnerCfg):
    """USD file to spawn cloth asset from.

    It uses the :class:`ClothObject` class to create a cloth object from USD and spawns the imported
    USD file. See :meth:`spawn_cloth_from_usd` for more information.
    ...
    func: Callable = from_files.spawn_cloth_from_usd
