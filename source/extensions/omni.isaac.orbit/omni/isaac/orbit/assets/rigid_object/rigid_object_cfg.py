...
from .rigid_object_with_attachment import RigidObjectWithAttachment
...
@configclass
class RigidObjectWithAttachmentCfg(RigidObjectCfg):
    """Configuration parameters for a rigid object."""

    attachments: Sequence[JointAttachmentCfg] | None = None

    class_type: type = RigidObjectWithAttachment
