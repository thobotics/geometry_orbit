...
class DeformableObjectData:
    ...
    Shape is ``(count, 2 * max_simulation_mesh_vertices_per_body, 3)``.
    """
    ...
    Shape is ``(count, max_simulation_mesh_elements_per_body, 4)``.
    """
    ...
    Shape is ``(count, max_collision_mesh_elements_per_body, 4)``.
    """
    ...
    Shape is ``(count, max_simulation_mesh_elements_per_body, 3, 3)``.
    """
    ...
    Shape is ``(count, max_collision_mesh_elements_per_body, 3, 3)``.
    """
    ...
    def nodal_pos_w(self) -> torch.Tensor:
        ...
        Shape is ``(count, max_simulation_mesh_vertices_per_body, 3)``.
        """
